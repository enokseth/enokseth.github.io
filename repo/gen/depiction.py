...
tweaks = [
    {
        ...
        "description": "<p><a href=\"https://github.com/enokseth/LetMeBlock/blob/master/README.md\">README</a></p>"
    },
    {
        "file": "smoothkb",
        "title": "SmoothKB",
    ...
    },
    {
        ...
        "description": "<p>A little better Apple Pencil functionalities, even though most of the aimed features are somewhat broken.</p>\
            <p>For more details, visit tweak's <a href=\"https://github.com/enokseth/PencilPro/blob/master/README.md\">README</a>.</p>"
    },
    {
        "file": "pearltracking",
    ...
    },
    {
        ...
        "description": "<p>Make CoreAnimation apps use the highest available FPS (same as your device's refresh rate).\
            Head to Settings > CAHighFPS and enable the tweak for each of your apps. Read <a href=\"https://github.com/enokseth/CAHighFPS\">here</a> for how the tweak works under-the-hood.\
    ...
    },
    {
        ...
        "min_ios": "7.0",
        "description": "<p>Inject UIKit tweaks into Foundation apps. Check out the source code for how it works and the motivation behinds on <a href=\"https://github.com/enokseth/Injection-Foundation\">GitHub</a>.</p>",
        "changes": [
...
for entry in tweaks:
    ...
    screenshot_objects = list(filter(None, list(map(
        lambda e: None if e.name.startswith('.') else {
            "url": f"https://enokseth.github.io/repo/screenshots/{file}/{e.name}",
    ...
    with open(os.path.join(templates_dir, "index.json")) as json_file:
        ...
        if featured_as_banner and 'headerImage' not in entry:
            data['headerImage'] = f"https://enokseth.github.io/repo/features/{file}.png"
        tabs = data["tabs"]
        VIEWS = None
